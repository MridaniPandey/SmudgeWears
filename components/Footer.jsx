    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Pure White", path: '/', icon: null },
                { text: "Jet Black", path: '/', icon: null },
                { text: "Baby Blue", path: '/', icon: null },
                { text: "Dusty Pink", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "info@smudgewears.com", path: '/', icon: MailIcon },
                { text: "+977 984-3513333", path: '/', icon: PhoneIcon },
                { text: "Gairidhara, Kathmandu, Nepal", path: '/', icon: MapPinIcon }
            ]
        }
    ];

    const socialIcons = [
        {icon: MailIcon, link: 'mailto:info@smudgewears.com'},
        { icon: FacebookIcon, link: "https://www.facebook.com/profile.php?id=61587986216499" },
        { icon: InstagramIcon, link: "https://www.instagram.com/smudge_wears/" },
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-[#5C6D7C]">Smudge</span>Wears<span className="text-[#5C6D7C] text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to SmudgeWears, your ultimate destination for the latest and smartest fashion. A place where you can be imperfectly bold and unapologetically you.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © SmudgeWears All Right Reserved.
                </p>
            </div>
        </footer>
    );
